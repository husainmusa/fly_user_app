...
exports.NewStoresPage = void 0;
var core_1 = require("@angular/core");
var moment = require("moment");
var NewStoresPage = /** @class */ (function () {
    ...
    NewStoresPage.prototype.ngOnInit = function () {
    };
    NewStoresPage.prototype.search = function () {
        this.haveSearch = !this.haveSearch;
    };
    NewStoresPage.prototype.onSearchChange = function (event) {
    ...
    NewStoresPage.prototype.openStore = function (item) {
    ...
    NewStoresPage.prototype.getTime = function (time) {
        // const date = moment().format('DD-MM-YYYY');
        // return moment(date + ' ' + time).format('hh:mm a');
        return moment(time, ['h:mm A']).format('hh:mm A');
    };
    NewStoresPage.prototype.getStores = function () {
        var _this = this;
        var param = {
        ...
        this.api.post('stores/getByCity', param).subscribe(function (stores) {
            ...
            if (stores && stores.status === 200 && stores.data && stores.data.length) {
                ...
                _this.stores.sort(function (b, a) { return a.id - b.id; });
                _this.dummy = [];
    ...
    NewStoresPage.prototype.isOpen = function (start, end) {
        var format = 'H:mm:ss';
    ...
    NewStoresPage.prototype.back = function () {
        this.navCtrl.back();
    };
    NewStoresPage = __decorate([
        core_1.Component({
            selector: 'app-new-stores',
            templateUrl: './new-stores.page.html',
            styleUrls: ['./new-stores.page.scss']
        })
    ], NewStoresPage);
    return NewStoresPage;
}());
exports.NewStoresPage = NewStoresPage;
