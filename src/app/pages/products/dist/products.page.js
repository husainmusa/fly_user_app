...
var ProductsPage = /** @class */ (function () {
    ...
    ProductsPage.prototype.sortFilter = function () {
        var _this = this;
    ...
    ProductsPage.prototype.changeMode = function () {
        this.mode = this.mode === 'grid' ? 'list' : 'grid';
    };
    ProductsPage.prototype.updateFilter = function () {
    ...
    ProductsPage.prototype.filter = function (events) {
    ...
    ProductsPage.prototype.add = function (product, index) {
        console.log(product);
    ...
    ProductsPage.prototype.remove = function (product, index) {
    ...
    ProductsPage.prototype.getProducts = function (limit, event) {
        var _this = this;
        var param = {
            id: this.id,
            limit: this.limit * 10,
    ...
    ProductsPage.prototype.checkCartItems = function () {
        var _this = this;
    ...
    ProductsPage.prototype.addToCart = function (item, index) {
        console.log(item);
        this.products[index].quantiy = 1;
        this.cart.addItem(item);
    };
    ProductsPage.prototype.checkCart = function (id) {
    ...
    ProductsPage.prototype.singleProduct = function (item) {
        var param = {
            queryParams: {
                id: item.id
            }
    ...
    ProductsPage.prototype.priceFilter = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    ProductsPage.prototype.variant = function (item, indeX) {
        return __awaiter(this, void 0, void 0, function () {
            var allData, alert;
            var _this = this;
            return __generator(this, function (_a) {
