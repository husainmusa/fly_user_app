    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(util, router, api, cart, chMod, iab, alertCtrl) {
        ...
        this.util.subscribeCity().subscribe(function (data) {
          ...
          _this.dummyTopProducts = Array(5); // this.dummyProducts = Array(5);
        ...
        value: function getInit() {
          ...
          this.api.post('stores/getByCity', param).subscribe(function (stores) {
            ...
            if (stores && stores.status === 200 && stores.data && stores.data.length) {
              ...
              console.log("before sort", _this3.stores);

              _this3.stores.forEach(function (val) {
                return _this3.storeCopy.push(Object.assign({}, val));
              });

              _this3.storeCopy = _this3.storeCopy.sort(function (b, a) {
                return a.id - b.id;
              });
              console.log("after sort=========>", _this3.storeCopy);
                    ...
                    if (element.second_variation && element.second_variation !== '') {
                      if (function (x) {
                        ...
                        if (element.second_variation) {
                          element.second_variation.forEach(function (elementInner) {
                        ...
                        element.second_variation = []; // element['variant'] = 1;
                      }
                    } // if (element.second_variation && element.second_variation !== '') {
              ...
              _this3.api.post('products/getHome', param).subscribe(function (data) {
                ...
                console.log(' this.topProducts', _this3.topProducts);
              }, function (error) {
                _this3.dummyTopProducts = [];
                console.log(error);
