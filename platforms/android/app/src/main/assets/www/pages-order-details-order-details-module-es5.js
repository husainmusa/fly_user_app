  ...
  function srcAppPagesOrderDetailsOrderDetailsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    OrderDetailsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _order_details_routing_module__WEBPACK_IMPORTED_MODULE_5__["OrderDetailsPageRoutingModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]],
  ...
  function srcAppPagesOrderDetailsOrderDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var OrderDetailsPage = /*#__PURE__*/function () {
      function OrderDetailsPage(route, util, api, navCtrl, alertController, router, iab, callNumber) {
        var _this = this;
      ...
      _createClass(OrderDetailsPage, [{
        ...
        value: function getOrder() {
          ...
          this.api.post('orders/getById', param).subscribe(function (data) {
            ...
            if (data && data.status === 200 && data.data.length > 0) {
              ...
              _this2.OrderCreationTime = info.date_time;
              console.log('OrderCreationTime', _this2.OrderCreationTime);

              if (_this2.OrderCreationTime) {
                var oderCreationTime = new Date(_this2.OrderCreationTime).getTime();
                ...
                console.log('oderCreationTime', new Date(_this2.OrderCreationTime));
              }
              ...
              if (info.paid_method == "online") {
                _this2.cashPaid = "Paid";
              } else {
                if (info.paid_method == "cod" && _this2.isDelivered) {
                  _this2.cashPaid = "Paid";
                } else if (info.paid_method == "cod" && !_this2.isDelivered) {
                  _this2.cashPaid = "Pending";
                }
              }

              console.log("cashPaid", info.paid_method, _this2.cashPaid); // if()

              _this2.datetime = moment__WEBPACK_IMPORTED_MODULE_7__(info.date_time).format('dddd, MMMM Do YYYY');
              _this2.payMethod = info.paid_method === 'cod' ? _this2.util.getString('COD') : 'Easy Card';
                              ...
                              case 0:
                                ...
                                this.api.post('acceptedorders/getByOrderId', orderParam).subscribe(function (accepteddata) {
                                  if (accepteddata && accepteddata.status === 200 && accepteddata.data.length > 0) {
                                    accepteddata.data.forEach(function (acceptedElement) {
                                            ...
                                            switch (_context.prev = _context.next) {
                                              case 0:
                                                if (acceptedElement.driver_id == element.id) {
                                                  this.driverInfo = element; // this.driverInfo.mobile = '0'+ this.driverInfo.mobile 
              ...
              _this2.api.post('stores/getStoresData', stores).subscribe(function (data) {
                ...
                if (data && data.status === 200 && data.data.length) {
                  ...
                  _this2.stores[0].mobile = '0' + _this2.stores[0].mobile;
                } else {
        ...
        key: "callStore",
        value: function callStore(tel) {
          if (tel[0] !== '+' && tel[0] !== '0') {
            tel = '0' + tel;
          }

          this.callNumber.callNumber(tel, true).then(function (res) {
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          ...
                          _this4.router.navigate(['order-rating'], param);
                        }
                      }]
                    });
        ...
        value: function changeStatus() {
          ...
          this.api.post('orders/editList', param).subscribe(function (data) {
            ...
            if (_this5.orderAt === 'home' && _this5.driverId !== '0') {// this.updateDriver(this.driverId, 'active');
            }

            if (data && data.status === 200) {
              _this5.sendNotification('cancelled');
        ...
        value: function sendNotification(value) {
          var sValue = [value, "__ED"].join();
          sValue = sValue.trim();

          if (this.userInfo && this.userInfo.fcm_token) {
            this.api.sendNotification(this.util.getString('Your order #') + this.id + ' ' + this.util.getString(sValue), this.util.getString('Order_ED') + ' ' + this.util.getString(sValue), this.userInfo.fcm_token).subscribe(function (data) {
                      ...
                      buttons: [{
                        ...
                        handler: function handler(data) {
                          ...
                          if (data && data === 'mail') {
                            ...
                            _this6.router.navigate(['inbox'], param);
                          }
                        }
                      }]
                    });
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler(data) {
                          ...
                          if (data && data === 'mail') {
                            _this7.emailStore(item.email);
                          } else if (data && data === 'call') {
                            _this7.callStore(item.mobile);
                          } else {
                            console.log('none');
                          }
                        }
