  ...
  function srcAppPagesCartCartPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var CartPage = /*#__PURE__*/function () {
      function CartPage(ngZone, util, alertCtrl, router, cart, api, navCtrl) {
        ...
        console.log(this.cart.cart, "this cart"); // this.cart.cart.forEach(element => {
      ...
      _createClass(CartPage, [{
        ...
        value: function ionViewWillEnter() {
          this.subItems(); // console.log(this.cart.cart, "this cart");
        ...
        value: function removeAllAdones(parent) {
          ...
          parent.variations[0].items.forEach(function (element) {
            ...
            _this2.cart.addAddOn('none', parent.id, element.quantity);
          });
        }
      }, {
        key: "rmSubAddOnQty",
        value: function rmSubAddOnQty(item, parent, type, event, index) {}
      }, {
        key: "addSubAddOnQty",
        value: function addSubAddOnQty(item, parent, type, event, index) {}
      }, {
        key: "minusAddOn",
        value: function minusAddOn(item, parent) {
          ...
          parent.variations[0].items.forEach(function (element) {
            if (element.id == id) {
              ...
              _this3.cart.addAddOn(id, parent.id, element.quantity);
            }
          });
        }
      }, {
        key: "subItems",
        value: function subItems() {
          this.subCart = [];
                    ...
                    return this.alertCtrl.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler(data) {
                          ...
                          console.log('before', _this4.cart.cart[indeX].variant);
                          _this4.cart.cart[indeX].variant = data;
                          console.log('after', _this4.cart.cart[indeX].variant);

                          _this4.cart.calcuate();
                        }
                      }]
                    });
        ...
        value: function addSubAddOn(item, parent, type, event, index) {
          ...
          this.ngZone.run(function () {
            ...
            _this5.cart.addSubAddOn(item.id, parent, qty, index, type);
          });
        }
      }, {
