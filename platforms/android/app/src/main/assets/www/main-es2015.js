...
CityGuard.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["MenuController"] }
];
CityGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _CityGuard_city_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CityGuard/city.guard */ "./src/app/CityGuard/city.guard.ts");
...
const routes = [
    ...
    {
        path: 'login',
        loadChildren: () => Promise.all(/*! import() | pages-login-login-module */[__webpack_require__.e("default~firebase-auth~pages-login-login-module"), __webpack_require__.e("pages-login-login-module")]).then(__webpack_require__.bind(null, /*! ./pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(m => m.LoginPageModule)
    },
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() | pages-home-home-module */[__webpack_require__.e("default~account-account-module~cart-cart-module~categories-categories-module~delivery-options-delive~a28c7eb7"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./pages/home/home.module */ "./src/app/pages/home/home.module.ts")).then(m => m.HomePageModule)
    },
    {
        path: 'categories',
        loadChildren: () => Promise.all(/*! import() | pages-categories-categories-module */[__webpack_require__.e("default~account-account-module~cart-cart-module~categories-categories-module~delivery-options-delive~a28c7eb7"), __webpack_require__.e("categories-categories-module")]).then(__webpack_require__.bind(null, /*! ./pages/categories/categories.module */ "./src/app/pages/categories/categories.module.ts")).then(m => m.CategoriesPageModule)
    },
    {
        path: 'store',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-store-store-module */ "store-store-module").then(__webpack_require__.bind(null, /*! ./pages/store/store.module */ "./src/app/pages/store/store.module.ts")).then(m => m.StorePageModule)
    },
    {
        path: 'product',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-product-product-module */ "product-product-module").then(__webpack_require__.bind(null, /*! ./pages/product/product.module */ "./src/app/pages/product/product.module.ts")).then(m => m.ProductPageModule)
    },
    {
        path: 'cart',
        loadChildren: () => Promise.all(/*! import() | pages-cart-cart-module */[__webpack_require__.e("default~account-account-module~cart-cart-module~categories-categories-module~delivery-options-delive~a28c7eb7"), __webpack_require__.e("cart-cart-module")]).then(__webpack_require__.bind(null, /*! ./pages/cart/cart.module */ "./src/app/pages/cart/cart.module.ts")).then(m => m.CartPageModule),
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'account',
        loadChildren: () => Promise.all(/*! import() | pages-account-account-module */[__webpack_require__.e("default~account-account-module~cart-cart-module~categories-categories-module~delivery-options-delive~a28c7eb7"), __webpack_require__.e("account-account-module")]).then(__webpack_require__.bind(null, /*! ./pages/account/account.module */ "./src/app/pages/account/account.module.ts")).then(m => m.AccountPageModule),
    },
    {
        path: 'orders',
        loadChildren: () => Promise.all(/*! import() | pages-orders-orders-module */[__webpack_require__.e("default~account-account-module~cart-cart-module~categories-categories-module~delivery-options-delive~a28c7eb7"), __webpack_require__.e("orders-orders-module")]).then(__webpack_require__.bind(null, /*! ./pages/orders/orders.module */ "./src/app/pages/orders/orders.module.ts")).then(m => m.OrdersPageModule)
    },
    {
        path: 'order-details',
        loadChildren: () => Promise.all(/*! import() | pages-order-details-order-details-module */[__webpack_require__.e("default~account-account-module~cart-cart-module~categories-categories-module~delivery-options-delive~a28c7eb7"), __webpack_require__.e("pages-order-details-order-details-module")]).then(__webpack_require__.bind(null, /*! ./pages/order-details/order-details.module */ "./src/app/pages/order-details/order-details.module.ts")).then(m => m.OrderDetailsPageModule)
    },
    {
        path: 'register',
    ...
    {
        path: 'reset-password',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-reset-password-reset-password-module */ "pages-reset-password-reset-password-module").then(__webpack_require__.bind(null, /*! ./pages/reset-password/reset-password.module */ "./src/app/pages/reset-password/reset-password.module.ts")).then(m => m.ResetPasswordPageModule)
    },
    {
        path: 'languages',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-languages-languages-module */ "languages-languages-module").then(__webpack_require__.bind(null, /*! ./pages/languages/languages.module */ "./src/app/pages/languages/languages.module.ts")).then(m => m.LanguagesPageModule)
    },
    {
        path: 'about',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-about-about-module */ "about-about-module").then(__webpack_require__.bind(null, /*! ./pages/about/about.module */ "./src/app/pages/about/about.module.ts")).then(m => m.AboutPageModule)
    },
    {
        path: 'payment',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-payment-payment-module */ "payment-payment-module").then(__webpack_require__.bind(null, /*! ./pages/payment/payment.module */ "./src/app/pages/payment/payment.module.ts")).then(m => m.PaymentPageModule)
    },
    {
        path: 'inbox',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-inbox-inbox-module */ "pages-inbox-inbox-module").then(__webpack_require__.bind(null, /*! ./pages/inbox/inbox.module */ "./src/app/pages/inbox/inbox.module.ts")).then(m => m.InboxPageModule)
    },
    {
        path: 'sub-category',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-sub-category-sub-category-module */ "sub-category-sub-category-module").then(__webpack_require__.bind(null, /*! ./pages/sub-category/sub-category.module */ "./src/app/pages/sub-category/sub-category.module.ts")).then(m => m.SubCategoryPageModule)
    },
    {
        path: 'products',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-products-products-module */ "products-products-module").then(__webpack_require__.bind(null, /*! ./pages/products/products.module */ "./src/app/pages/products/products.module.ts")).then(m => m.ProductsPageModule)
    },
    {
        path: 'profile',
    ...
    {
        path: 'cities',
        loadChildren: () => Promise.all(/*! import() | pages-cities-cities-module */[__webpack_require__.e("default~account-account-module~cart-cart-module~categories-categories-module~delivery-options-delive~a28c7eb7"), __webpack_require__.e("pages-cities-cities-module")]).then(__webpack_require__.bind(null, /*! ./pages/cities/cities.module */ "./src/app/pages/cities/cities.module.ts")).then(m => m.CitiesPageModule)
    },
    {
        path: 'offers',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-offers-offers-module */ "pages-offers-offers-module").then(__webpack_require__.bind(null, /*! ./pages/offers/offers.module */ "./src/app/pages/offers/offers.module.ts")).then(m => m.OffersPageModule)
    },
    {
        path: 'top-picked',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-top-picked-top-picked-module */ "top-picked-top-picked-module").then(__webpack_require__.bind(null, /*! ./pages/top-picked/top-picked.module */ "./src/app/pages/top-picked/top-picked.module.ts")).then(m => m.TopPickedPageModule)
    },
    {
        path: 'top-stores',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-top-stores-top-stores-module */ "pages-top-stores-top-stores-module").then(__webpack_require__.bind(null, /*! ./pages/top-stores/top-stores.module */ "./src/app/pages/top-stores/top-stores.module.ts")).then(m => m.TopStoresPageModule)
    },
    {
        path: 'all-offers',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-all-offers-all-offers-module */ "pages-all-offers-all-offers-module").then(__webpack_require__.bind(null, /*! ./pages/all-offers/all-offers.module */ "./src/app/pages/all-offers/all-offers.module.ts")).then(m => m.AllOffersPageModule)
    },
    {
        path: 'address',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-address-address-module */ "address-address-module").then(__webpack_require__.bind(null, /*! ./pages/address/address.module */ "./src/app/pages/address/address.module.ts")).then(m => m.AddressPageModule)
    },
    {
        path: 'add-address',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-add-address-add-address-module */ "pages-add-address-add-address-module").then(__webpack_require__.bind(null, /*! ./pages/add-address/add-address.module */ "./src/app/pages/add-address/add-address.module.ts")).then(m => m.AddAddressPageModule)
    },
    {
        path: 'delivery-options',
        loadChildren: () => Promise.all(/*! import() | pages-delivery-options-delivery-options-module */[__webpack_require__.e("default~account-account-module~cart-cart-module~categories-categories-module~delivery-options-delive~a28c7eb7"), __webpack_require__.e("delivery-options-delivery-options-module")]).then(__webpack_require__.bind(null, /*! ./pages/delivery-options/delivery-options.module */ "./src/app/pages/delivery-options/delivery-options.module.ts")).then(m => m.DeliveryOptionsPageModule)
    },
    {
        path: 'stripe-payments',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-stripe-payments-stripe-payments-module */ "stripe-payments-stripe-payments-module").then(__webpack_require__.bind(null, /*! ./pages/stripe-payments/stripe-payments.module */ "./src/app/pages/stripe-payments/stripe-payments.module.ts")).then(m => m.StripePaymentsPageModule)
    },
    {
        path: 'add-card',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-add-card-add-card-module */ "add-card-add-card-module").then(__webpack_require__.bind(null, /*! ./pages/add-card/add-card.module */ "./src/app/pages/add-card/add-card.module.ts")).then(m => m.AddCardPageModule)
    },
    {
        path: 'favorite',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-favorite-favorite-module */ "pages-favorite-favorite-module").then(__webpack_require__.bind(null, /*! ./pages/favorite/favorite.module */ "./src/app/pages/favorite/favorite.module.ts")).then(m => m.FavoritePageModule)
    },
    {
        path: 'contacts',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-contacts-contacts-module */ "contacts-contacts-module").then(__webpack_require__.bind(null, /*! ./pages/contacts/contacts.module */ "./src/app/pages/contacts/contacts.module.ts")).then(m => m.ContactsPageModule)
    },
    {
        path: 'order-rating',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-order-rating-order-rating-module */ "pages-order-rating-order-rating-module").then(__webpack_require__.bind(null, /*! ./pages/order-rating/order-rating.module */ "./src/app/pages/order-rating/order-rating.module.ts")).then(m => m.OrderRatingPageModule)
    },
    {
        path: 'store-rating',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./pages/store-rating/store-rating.module */ "./src/app/pages/store-rating/store-rating.module.ts")).then(m => m.StoreRatingPageModule)
    },
    {
        path: 'product-rating',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./pages/product-rating/product-rating.module */ "./src/app/pages/product-rating/product-rating.module.ts")).then(m => m.ProductRatingPageModule)
    },
    {
        path: 'rating-list',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-rating-list-rating-list-module */ "rating-list-rating-list-module").then(__webpack_require__.bind(null, /*! ./pages/rating-list/rating-list.module */ "./src/app/pages/rating-list/rating-list.module.ts")).then(m => m.RatingListPageModule)
    },
    {
        path: 'chats',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-chats-chats-module */ "pages-chats-chats-module").then(__webpack_require__.bind(null, /*! ./pages/chats/chats.module */ "./src/app/pages/chats/chats.module.ts")).then(m => m.ChatsPageModule)
    },
    {
        path: 'driver-rating',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./pages/driver-rating/driver-rating.module */ "./src/app/pages/driver-rating/driver-rating.module.ts")).then(m => m.DriverRatingPageModule)
    },
    {
        path: 'faqs',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-faqs-faqs-module */ "faqs-faqs-module").then(__webpack_require__.bind(null, /*! ./pages/faqs/faqs.module */ "./src/app/pages/faqs/faqs.module.ts")).then(m => m.FaqsPageModule)
    },
    {
        path: 'help',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-help-help-module */ "help-help-module").then(__webpack_require__.bind(null, /*! ./pages/help/help.module */ "./src/app/pages/help/help.module.ts")).then(m => m.HelpPageModule)
    },
    {
        path: 'sort',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./pages/sort/sort.module */ "./src/app/pages/sort/sort.module.ts")).then(m => m.SortPageModule)
    },
    {
        path: 'verify',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./pages/verify/verify.module */ "./src/app/pages/verify/verify.module.ts")).then(m => m.VerifyPageModule)
    },
    {
        path: 'direction',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-direction-direction-module */ "pages-direction-direction-module").then(__webpack_require__.bind(null, /*! ./pages/direction/direction.module */ "./src/app/pages/direction/direction.module.ts")).then(m => m.DirectionPageModule)
    },
    {
        path: 'success',
        loadChildren: () => __webpack_require__.e(/*! import() | success-success-module */ "success-success-module").then(__webpack_require__.bind(null, /*! ./success/success.module */ "./src/app/success/success.module.ts")).then(m => m.SuccessPageModule)
    },
    {
        path: 'new-stores',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-new-stores-new-stores-module */ "pages-new-stores-new-stores-module").then(__webpack_require__.bind(null, /*! ./pages/new-stores/new-stores.module */ "./src/app/pages/new-stores/new-stores.module.ts")).then(m => m.NewStoresPageModule)
    },
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, navCtrl, oneSignal, api, util, cart, router, menuCtrl, db) {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            ...
            if (!lng || lng === null) {
                this.api.get('users/getDefaultSettings').subscribe((data) => {
                ...
                this.api.post('users/getDefaultSettingsById', param).subscribe((data) => {
                    console.log('----------------- app setting', data);
                    if (data && data.status === 200 && data.data) {
                        const manage = data.data.manage;
                        const language = data.data.lang;
            ...
            if (this.platform.is('cordova')) {
                setTimeout(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                    yield this.oneSignal.startInit(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].onesignal.appId, src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].onesignal.googleProjectNumber);
            ...
            if (uid && uid !== null && uid !== 'null') {
                ...
                this.api.post('favourite/getByUid', param).subscribe((data) => {
...
/* harmony import */ var _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @ionic-native/splash-screen/ngx */ "./node_modules/@ionic-native/splash-screen/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @ionic-native/status-bar/ngx */ "./node_modules/@ionic-native/status-bar/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_storage__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @ionic/storage */ "./node_modules/@ionic/storage/__ivy_ngcc__/fesm2015/ionic-storage.js");
/* harmony import */ var _ionic_native_android_permissions_ngx__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @ionic-native/android-permissions/ngx */ "./node_modules/@ionic-native/android-permissions/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_diagnostic_ngx__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @ionic-native/diagnostic/ngx */ "./node_modules/@ionic-native/diagnostic/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @ionic-native/geolocation/ngx */ "./node_modules/@ionic-native/geolocation/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_location_accuracy_ngx__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @ionic-native/location-accuracy/ngx */ "./node_modules/@ionic-native/location-accuracy/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @ionic-native/in-app-browser/ngx */ "./node_modules/@ionic-native/in-app-browser/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _pages_store_rating_store_rating_module__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./pages/store-rating/store-rating.module */ "./src/app/pages/store-rating/store-rating.module.ts");
/* harmony import */ var _pages_product_rating_product_rating_module__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./pages/product-rating/product-rating.module */ "./src/app/pages/product-rating/product-rating.module.ts");
/* harmony import */ var _pages_driver_rating_driver_rating_module__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./pages/driver-rating/driver-rating.module */ "./src/app/pages/driver-rating/driver-rating.module.ts");
...
/* harmony import */ var _pages_sort_sort_module__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./pages/sort/sort.module */ "./src/app/pages/sort/sort.module.ts");
/* harmony import */ var _pages_verify_verify_module__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./pages/verify/verify.module */ "./src/app/pages/verify/verify.module.ts");
/* harmony import */ var _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! @ionic-native/native-geocoder/ngx */ "./node_modules/@ionic-native/native-geocoder/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _ionic_native_call_number_ngx__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! @ionic-native/call-number/ngx */ "./node_modules/@ionic-native/call-number/__ivy_ngcc__/ngx/index.js");
/*
  Authors : initappz (Rahul Jograna)
  Website : https://initappz.com/
  App Name : ionic 5 groceryee app
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _pages_store_rating_store_rating_module__WEBPACK_IMPORTED_MODULE_26__["StoreRatingPageModule"],
            _pages_product_rating_product_rating_module__WEBPACK_IMPORTED_MODULE_27__["ProductRatingPageModule"],
            _pages_driver_rating_driver_rating_module__WEBPACK_IMPORTED_MODULE_28__["DriverRatingPageModule"],
            _pages_verify_verify_module__WEBPACK_IMPORTED_MODULE_31__["VerifyPageModule"],
            _pages_sort_sort_module__WEBPACK_IMPORTED_MODULE_30__["SortPageModule"],
        ...
        providers: [
            ...
            _ionic_native_android_permissions_ngx__WEBPACK_IMPORTED_MODULE_21__["AndroidPermissions"],
            ...
            _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_32__["NativeGeocoder"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DriverRatingPageRoutingModule", function() { return DriverRatingPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _driver_rating_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./driver-rating.page */ "./src/app/pages/driver-rating/driver-rating.page.ts");
...
let DriverRatingPageRoutingModule = class DriverRatingPageRoutingModule {
};
DriverRatingPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DriverRatingPageModule", function() { return DriverRatingPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _driver_rating_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./driver-rating-routing.module */ "./src/app/pages/driver-rating/driver-rating-routing.module.ts");
/* harmony import */ var _driver_rating_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./driver-rating.page */ "./src/app/pages/driver-rating/driver-rating.page.ts");
/* harmony import */ var ionic4_rating__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ionic4-rating */ "./node_modules/ionic4-rating/__ivy_ngcc__/dist/index.js");
...
let DriverRatingPageModule = class DriverRatingPageModule {
};
DriverRatingPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _driver_rating_routing_module__WEBPACK_IMPORTED_MODULE_5__["DriverRatingPageRoutingModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DriverRatingPage", function() { return DriverRatingPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
...
let DriverRatingPage = class DriverRatingPage {
    constructor(navParam, modalCtrl, util, api) {
        ...
        this.util.show();
        this.api.post('rating/getFromCount', param).subscribe((data) => {
            this.util.hide();
    ...
    submit() {
        ...
        this.util.show();
        this.api.post('rating/save', param).subscribe((data) => {
            console.log(data);
            this.util.hide();
            if (data && data.status === 200) {
...
DriverRatingPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: src_app_services_util_service__WEBPACK_IMPORTED_MODULE_3__["UtilService"] },
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] }
];
DriverRatingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-driver-rating',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./driver-rating.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/driver-rating/driver-rating.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./driver-rating.page.scss */ "./src/app/pages/driver-rating/driver-rating.page.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProductRatingPageRoutingModule", function() { return ProductRatingPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _product_rating_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./product-rating.page */ "./src/app/pages/product-rating/product-rating.page.ts");
...
let ProductRatingPageRoutingModule = class ProductRatingPageRoutingModule {
};
ProductRatingPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]],
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProductRatingPageModule", function() { return ProductRatingPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _product_rating_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./product-rating-routing.module */ "./src/app/pages/product-rating/product-rating-routing.module.ts");
/* harmony import */ var _product_rating_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./product-rating.page */ "./src/app/pages/product-rating/product-rating.page.ts");
/* harmony import */ var ionic4_rating__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ionic4-rating */ "./node_modules/ionic4-rating/__ivy_ngcc__/dist/index.js");
...
let ProductRatingPageModule = class ProductRatingPageModule {
};
ProductRatingPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _product_rating_routing_module__WEBPACK_IMPORTED_MODULE_5__["ProductRatingPageRoutingModule"],
            ionic4_rating__WEBPACK_IMPORTED_MODULE_7__["IonicRatingModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProductRatingPage", function() { return ProductRatingPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var src_app_services_util_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/util.service */ "./src/app/services/util.service.ts");
...
let ProductRatingPage = class ProductRatingPage {
    constructor(navParam, modalCtrl, util, api) {
        this.navParam = navParam;
        this.modalCtrl = modalCtrl;
        this.util = util;
    ...
    submit() {
        ...
        this.api.post('rating/save', param).subscribe((data) => {
            ...
            if (data && data.status === 200) {
                ...
                this.api.post('products/editList', storeParam).subscribe((stores) => {
...
ProductRatingPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: src_app_services_util_service__WEBPACK_IMPORTED_MODULE_3__["UtilService"] },
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] }
];
ProductRatingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-product-rating',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./product-rating.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/product-rating/product-rating.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./product-rating.page.scss */ "./src/app/pages/product-rating/product-rating.page.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
        src_app_services_util_service__WEBPACK_IMPORTED_MODULE_3__["UtilService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SortPageRoutingModule", function() { return SortPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _sort_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sort.page */ "./src/app/pages/sort/sort.page.ts");
...
let SortPageRoutingModule = class SortPageRoutingModule {
};
SortPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]],
    })
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _sort_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sort-routing.module */ "./src/app/pages/sort/sort-routing.module.ts");
/* harmony import */ var _sort_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sort.page */ "./src/app/pages/sort/sort.page.ts");
...
SortPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _sort_routing_module__WEBPACK_IMPORTED_MODULE_5__["SortPageRoutingModule"]
        ],
...
SortPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-sort',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./sort.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/sort/sort.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./sort.page.scss */ "./src/app/pages/sort/sort.page.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StoreRatingPageRoutingModule", function() { return StoreRatingPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _store_rating_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./store-rating.page */ "./src/app/pages/store-rating/store-rating.page.ts");
...
let StoreRatingPageRoutingModule = class StoreRatingPageRoutingModule {
};
StoreRatingPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]],
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StoreRatingPageModule", function() { return StoreRatingPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _store_rating_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./store-rating-routing.module */ "./src/app/pages/store-rating/store-rating-routing.module.ts");
/* harmony import */ var _store_rating_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./store-rating.page */ "./src/app/pages/store-rating/store-rating.page.ts");
/* harmony import */ var ionic4_rating__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ionic4-rating */ "./node_modules/ionic4-rating/__ivy_ngcc__/dist/index.js");
...
let StoreRatingPageModule = class StoreRatingPageModule {
};
StoreRatingPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _store_rating_routing_module__WEBPACK_IMPORTED_MODULE_5__["StoreRatingPageRoutingModule"],
            ionic4_rating__WEBPACK_IMPORTED_MODULE_7__["IonicRatingModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StoreRatingPage", function() { return StoreRatingPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var src_app_services_util_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/util.service */ "./src/app/services/util.service.ts");
...
let StoreRatingPage = class StoreRatingPage {
    constructor(navParam, modalCtrl, util, api) {
        this.navParam = navParam;
        this.modalCtrl = modalCtrl;
        this.util = util;
    ...
    submit() {
        ...
        this.api.post('rating/save', param).subscribe((data) => {
            ...
            if (data && data.status === 200) {
                ...
                this.api.post('stores/editByUid', storeParam).subscribe((stores) => {
...
StoreRatingPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    { type: src_app_services_util_service__WEBPACK_IMPORTED_MODULE_3__["UtilService"] },
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] }
];
StoreRatingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-store-rating',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./store-rating.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/store-rating/store-rating.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./store-rating.page.scss */ "./src/app/pages/store-rating/store-rating.page.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
        src_app_services_util_service__WEBPACK_IMPORTED_MODULE_3__["UtilService"],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _translate_translate_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./translate/translate.pipe */ "./src/app/pipes/translate/translate.pipe.ts");
/* harmony import */ var _currency_currency_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./currency/currency.pipe */ "./src/app/pipes/currency/currency.pipe.ts");
/*
  Authors : initappz (Rahul Jograna)
  Website : https://initappz.com/
  App Name : ionic 5 groceryee app
...
let ApiService = class ApiService {
    ...
    updateStoreOrderStatus(storeUid) {
        const today = new Date();
        const itemRef = this.firbaseDB.object(['store', storeUid].join('/'));
    ...
    // }
    otplogin(data) {
        return this.http.post(this.baseUrl + 'users/otplogin', data)
    ...
    createOrderNotification(stores) {
        ...
        let traverse = () => {
            if (ids.length > 0) {
                ...
                if (idToken != "") {
                    this.sendNotification(this.util.getString('You have received new order'), this.util.getString('New Order Received'), idToken).toPromise().then((r) => {
...
let CartService = class CartService {
    constructor(api, util, alertController, navCtrl) {
        this.api = api;
        this.util = util;
        ...
        this.api.get('general/index').subscribe((data) => {
            if (data.status == 200) {
    ...
    calcuate() {
        ...
        if (this.stores && this.stores.length && this.deliveryAddress && this.deliveryAt === 'home') {
            ...
            this.stores.forEach((element) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                ...
                const distance = yield this.distanceInKmBetweenEarthCoordinates(this.deliveryAddress.lat, this.deliveryAddress.lng, element.lat, element.lng);
    ...
    getStoreInfo(id) {
        ...
        this.api.post('stores/getByUid', parms).subscribe((data) => {
            if (data.status == 200) {
...
let UtilService = class UtilService {
    constructor(loadingCtrl, alertCtrl, toastCtrl, router, navCtrl, menuCtrl, storage) {
        ...
        this.favIds = [];
        this.newAddress = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        // public creds = {
        //   sid: '',
        //   token: '',
        //   from: ''
...
module.exports = __webpack_require__(/*! E:\puneet\flyvip_23-03-22\User_app_06-04-2021\src\main.ts */"./src/main.ts");
